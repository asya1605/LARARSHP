...
<section class="min-h-[90vh] bg-[#f5f7ff] py-10">
  <div class="max-w-lg mx-auto bg-white p-8 rounded-xl shadow-md border border-gray-200">
    ...
    <form action="{{ route('admin.ras_hewan.update', $ras->idras_hewan) }}" method="POST" class="space-y-5">
      @csrf
      ...
      <div class="flex justify-between mt-8">
        <a href="{{ route('admin.ras_hewan.index') }}" class="bg-gray-200 hover:bg-gray-300 text-gray-800 px-4 py-2 rounded-lg">⬅️ Batal</a>
