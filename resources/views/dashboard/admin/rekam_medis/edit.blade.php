...
<section class="min-h-[90vh] bg-[#f5f7ff] flex justify-center items-center">
  <div class="bg-white shadow-md rounded-xl p-8 w-full max-w-4xl border border-gray-200">
    ...
    <form method="POST" action="{{ route('admin.rekam_medis.update', $item->idrekam_medis) }}" class="grid md:grid-cols-2 gap-4">
      @csrf
      @method('PUT')
      ...
      <div class="md:col-span-2 flex justify-between mt-4">
        <a href="{{ route('admin.rekam_medis.index') }}" class="text-gray-600 hover:text-gray-800 text-sm">← Batal</a>
